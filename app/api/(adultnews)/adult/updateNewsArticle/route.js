...
import { ADULT_NEWS, ADULT_NEWS_TO_CATEGORIES } from "@/utils/schema";
...
console.log("image",image)
  ...
  try {
    // Step 1: Update the news fields in the ADULT_NEWS table
    await db
      .update(ADULT_NEWS)
      .set({
        title,
    ...
    // Step 2: Remove existing category mappings for this news ID in ADULT_NEWS_TO_CATEGORIES
    await db
