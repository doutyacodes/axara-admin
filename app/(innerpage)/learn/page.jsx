    ...
    <div className="min-h-screen bg-gray-50/30">
      <div className="p-2 sm:p-4 md:p-6 max-w-7xl mx-auto">
        <header className="text-center mb-4 sm:mb-6 md:mb-8">
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-orange-600 mb-1 sm:mb-2">Learn Topic & Quiz</h1>
          <p className="text-sm sm:text-base text-gray-600">Manage your news articles and categories</p>
        </header>

        <Tabs defaultValue="add-topic" className="w-full">
          <TabsList className="w-full mb-4 sm:mb-6 md:mb-8 bg-gray-100 p-1 rounded-xl">
            <TabsTrigger 
              value="add-topic" 
              className="text-sm sm:text-base flex-1 data-[state=active]:bg-orange-500 data-[state=active]:text-white rounded-lg transition-all duration-200"
            >
              Add Topic
            </TabsTrigger>
            <TabsTrigger 
