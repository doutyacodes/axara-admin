  ...
  const handleDeleteConfirmation = async () => {
    ...
    try {
      ...
      if (response.status === 201) {
        ...
        const errorMessage = response.data?.message || 'News Deleted Successfully';
       ...
       {showNewsSection ? (
         <> 
          ...
          <>
            ...
            <EditNews selectedNews={selectedNews} selectedAge={selectedAge} setShowEditSection={setShowEditSection}/>
          </>
        ):(
